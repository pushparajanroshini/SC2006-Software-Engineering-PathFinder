...
//           .then((response) => response.text())
//           .then((endResult) => {
//             console.log("End Address Data:", endResult);
            
//             // Call a function to handle the fetched data
//             //handleAddressData(startResult, endResult);
//           })
...
//   // Example function to handle the fetched address data
//   //function handleAddressData(startData, endData) {
//     // Handle the start and end address data here
//     //console.log("Start Address Data:", startData);
//     //console.log("End Address Data:", endData);
//   //}
...
//   // Dynamic search values for start and end addresses
//   let startAddress = "Parliament of Singapore";
